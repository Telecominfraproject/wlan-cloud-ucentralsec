...
namespace OpenWifi {
	...
	static ORM::FieldVec PreferencesDB_Fields{ORM::Field{"id", 36, true},
											  ORM::Field{"modified", ORM::FieldType::FT_BIGINT},
											  ORM::Field{"data", ORM::FieldType::FT_TEXT}};

	PreferencesDB::PreferencesDB(const std::string &TableName, const std::string &Shortname,
	...
	bool PreferencesDB::DeletePreferences([[maybe_unused]] const std::string &AdminId,
										  std::string &Id) {
...
template <>
void ORM::DB<OpenWifi::PreferencesRecordTuple, OpenWifi::SecurityObjects::Preferences>::Convert(
	const OpenWifi::PreferencesRecordTuple &R, OpenWifi::SecurityObjects::Preferences &P) {
	P.id = R.get<0>();
	P.modified = R.get<1>();
...
template <>
void ORM::DB<OpenWifi::PreferencesRecordTuple, OpenWifi::SecurityObjects::Preferences>::Convert(
	const OpenWifi::SecurityObjects::Preferences &P, OpenWifi::PreferencesRecordTuple &R) {
	R.set<0>(P.id);
	R.set<1>(P.modified);
